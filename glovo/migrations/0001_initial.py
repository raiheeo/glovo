    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='glovo.combo')),
            ],
        ),
        migrations.AddField(
            model_name='combo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courier_deliveries', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Courier',
            fields=[
                ...
                ('current_orders', models.ManyToManyField(blank=True, related_name='couriers', to='glovo.order')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
